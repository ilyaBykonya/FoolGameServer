...
void Server::slotNewConnection()
{
    ...
    QObject::connect(player, &Player::messageSignalUserSendMessageOnCanal, this, &Server::messageSignalSendUserMessage);
    QObject::connect(this, &Server::messageSignalSendUserMessage, player, &Player::messageSlotReceiveMessageFromUser);
