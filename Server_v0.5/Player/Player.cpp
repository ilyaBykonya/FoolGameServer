...
MyPlayer::MyPlayer(qint16 id, QTcpSocket* socket, QObject *parent)
    :QObject{ parent },
     m_nextDataBlockSize{ 0 },
     m_ID{ id },
     m_socket{ socket }
    {
        QObject::connect(m_socket, &QTcpSocket::readyRead, this, &MyPlayer::slotReadClient);
...
void MyPlayer::slotReadFromAppToServ(QDataStream& dataBlock)
{
    ...
    switch (typeSignal)
    {
        ...
        case EthernetSignals::ClientSignal::ApplicationSignal::PlayerRegistration        :
        {
            QString name;
            QString password;
            dataBlock >> name >> password;
            qDebug() << QString("READ PLAYER REGISTRATION [%1::%2]").arg(name).arg(password);
            emit this->applicationSignalPlayerRegistration(name, password);

            break;
        }
    }
}
void MyPlayer::slotReadFromAppInstToServInst(QDataStream& dataBlock)
{
...
void MyPlayer::slotInstancePlayerTakeAllCards(qint16 playerID)
{
...
void MyPlayer::slotInstancePlayerTossedCard(qint16 playerID, Card::Suit cardSuit, Card::Dignity cardDignity)
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
...
void MyPlayer::slotInstancePlayerBeatCard(qint16 playerID, qint16 pairID, Card::Suit cardSuit, Card::Dignity cardDignity)
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
...
void MyPlayer::slotInstancePlayerTransferable(qint16 playerID, Card::Suit cardSuit, Card::Dignity cardDignity)
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
...
void MyPlayer::slotInstanceTakeCardFromDeck(qint16 playerID, Card::Suit cardSuit, Card::Dignity cardDignity)
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
...
void MyPlayer::slotInstanceSetNewMainPlayersPair(qint16 attackerID, qint16 defenderID)
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
    outStream << qint16(0)
              << EthernetSignals::ServerSignal::TypeSignal::FromServInstToAppInst
              << EthernetSignals::ServerSignal::InstanceSignal::SetNewMainPlayersPair
              << attackerID
              << defenderID;

    outStream.device()->seek(0);
    outStream << qint16(dataBlock.size() - sizeof(qint16));
    qDebug() << QString("EMIT NEW MAIN PAIR [%1:%2]").arg(attackerID).arg(defenderID);
    m_socket->write(dataBlock);
}
void MyPlayer::slotInstanceMakeTurn()
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
...
void MyPlayer::slotInstanceUnsuccesfullyToss(Card::Suit cardSuit, Card::Dignity cardDignity, qint16 pairID)
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
    ...
    outStream.device()->seek(0);
    outStream << qint16(dataBlock.size() - sizeof(qint16));
    qDebug() << QString("EMIT TOSS UNSUCCESFULLY");
    m_socket->write(dataBlock);
}
void MyPlayer::slotInstanceUnsuccesfullyBeat(Card::Suit cardSuit, Card::Dignity cardDignity, qint16 pairID)
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
...
void MyPlayer::slotInstanceUnsuccesfullyTrancferable(Card::Suit cardSuit, Card::Dignity cardDignity, qint16 pairID)
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
...
void MyPlayer::slotInstanceEndOfMatch(qint16 wonMoney)
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
...
void MyPlayer::serverSlotSendID()
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
...
void MyPlayer::serverSlotGetAllPlayInstanceOptions(Card::Suit trumpS, Card::Dignity trumpD, QList<MyPlayer*> players, qint16 attacker, qint16 defender, qint16 sizeOfDeck)
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
...
void MyPlayer::serverSlotAlertMessage(const QString& title, const QString& message)
{
    QByteArray dataBlock;
    QDataStream outStream(&dataBlock, QIODevice::OpenModeFlag::WriteOnly);
    outStream.setVersion(QDataStream::Version::Qt_5_14);
